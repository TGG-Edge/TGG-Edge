...
<a href="{{ route('tgg-fct.researcher.profile') }}" class="{{ request()->is('user/profile') ? 'active' : '' }}"><i class="fas fa-user"></i> Profile</a>
...
<div class="dropdown">
    ...
    <div class="collapse ps-3 {{ request()->is('user/research-assistance/*') ? 'show ' : '' }}" id="researchDropdown">
        <a href="{{ route('tgg-fct.researcher.research-assistance.literature') }}"><i class="fas fa-chart-bar"></i> Literature</a>
        <a href="{{ route('tgg-fct.researcher.research-assistance.videos') }}"><i class="fas fa-video"></i> Videos</a>
        <a href="{{ route('tgg-fct.researcher.research-assistance.links') }}"><i class="fas fa-link"></i> Links</a>
        <a href="{{ route('tgg-fct.researcher.research-assistance.linkedin') }}"><i class="fab fa-linkedin"></i> LinkedIn</a>
    </div>
</div>
@endif
...
<div class="dropdown">
    ...
    <div class="collapse ps-3 {{ request()->is('user/login') || request()->is('uses/researcher') ? 'show' : '' }}"
         id="sitemaplink">
        <a href="{{ route('tgg-fct.researcher.login') }}" class="d-block py-1" target="_blank" rel="noopener noreferrer">
...
<div class="dropdown">
    ...
    <div class="collapse ps-3 {{ request()->is('user/new-applications*') || request()->is('user/processed-applications*') ? 'show' : '' }}"
        ...
        <a href="{{ route('tgg-fct.researcher.new-applications') }}" class="d-block py-1">
            <i class="fas fa-user-plus me-2"></i> New Applications
        </a>
        <a href="{{ route('tgg-fct.researcher.processed-applications') }}" class="d-block py-1">
...
<div class="dropdown">
    ...
    <div class="collapse ps-3 {{ request()->is('user/researcher-projects*') || request()->is('user/volunteer-projects*') ? 'show' : '' }}"
         id="projectDropdown">
        <a href="{{ route('tgg-fct.researcher.researcher-projects') }}" class="d-block py-1">
            <i class="fas fa-flask me-2"></i> Researcher Projects
        </a>
        
        <a href="{{ route('tgg-fct.researcher.volunteer-projects') }}" class="d-block py-1">
