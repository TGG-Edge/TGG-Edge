...
@php
    if(auth()->user()->user_role == 1){
        $dashboardRoute = route('tgg-fct.admin.dashboard'); 

    }elseif(auth()->user()->user_role == 2){
        $dashboardRoute = route('tgg-fct.researcher.dashboard'); 

    }elseif(auth()->user()->user_role == 3){
        $dashboardRoute = route('tgg-fct.volunteer.dashboard'); 
...
<a href="{{ route('tgg-fct.volunteer.profile') }}" class="{{ request()->is('user/profile') ? 'active' : '' }}"><i class="fas fa-user"></i> Profile</a>
...
<div class="dropdown">
    ...
    <div class="collapse ps-3 {{ request()->is('user/research-assistance/*') ? 'show ' : '' }}" id="researchDropdown">
        <a href="{{ route('tgg-fct.volunteer.research-assistance.literature') }}"><i class="fas fa-chart-bar"></i> Literature</a>
        <a href="{{ route('tgg-fct.volunteer.research-assistance.videos') }}"><i class="fas fa-video"></i> Videos</a>
        <a href="{{ route('tgg-fct.volunteer.research-assistance.links') }}"><i class="fas fa-link"></i> Links</a>
        <a href="{{ route('tgg-fct.volunteer.research-assistance.linkedin') }}"><i class="fab fa-linkedin"></i> LinkedIn</a>
    </div>
</div>
@endif


<a href="{{ route('tgg-fct.volunteer.knowledge-research.index') }}" class="{{ request()->is('user/knowledge-research') ? 'active' : '' }}">
...
<div class="dropdown">
    ...
    <div class="collapse ps-3 {{ request()->is('user/login') || request()->is('uses/researcher') ? 'show' : '' }}"
         id="sitemaplink">
        <a href="{{ route('tgg-fct.volunteer.login') }}" class="d-block py-1" target="_blank" rel="noopener noreferrer">
...
<div class="dropdown">
    ...
    <div class="collapse ps-3 {{ request()->is('user/new-applications*') || request()->is('user/processed-applications*') ? 'show' : '' }}"
        ...
        <a href="{{ route('tgg-fct.volunteer.new-applications') }}" class="d-block py-1">
            <i class="fas fa-user-plus me-2"></i> New Applications
        </a>
        <a href="{{ route('tgg-fct.volunteer.processed-applications') }}" class="d-block py-1">
...
<div class="dropdown">
    ...
    <div class="collapse ps-3 {{ request()->is('user/researcher-projects*') || request()->is('user/volunteer-projects*') ? 'show' : '' }}"
         id="projectDropdown">
        <a href="{{ route('tgg-fct.volunteer.researcher-projects') }}" class="d-block py-1">
            <i class="fas fa-flask me-2"></i> Researcher Projects
        </a>
        
        <a href="{{ route('tgg-fct.volunteer.volunteer-projects') }}" class="d-block py-1">
