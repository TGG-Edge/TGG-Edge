...
@section('title', 'Volunteer Dashboard | Tgg Edge | Tgg Fct')

@section('content')
<div class="main-container">
    <div class="para-text">
        <p>Hello <strong>{{ Auth::user()->name ?? 'User' }}</strong> (not <strong>{{ Auth::user()->name ?? 'User' }}</strong>? <a href="{{ route('tgg-fct.logout') }}">Log out</a>)</p>
    ...
    {{-- Dashboard Volunteer HTML --}}
        ...
        <div class="top-section">
            <div class="projects-list">
                ...
                <form action="{{route('tgg-fct.volunteer.project-collaboration.apply')}}" method="POST">
                    @csrf
                    ...
                    <tbody>
                        @if($collaborated_projects->count() > 0)
                            ...
                            @foreach($collaborated_projects as $index => $project)
                             <form action="{{ route('tgg-fct.volunteer.project-collaboration.progress.update') }}" method="POST">
                    @csrf
