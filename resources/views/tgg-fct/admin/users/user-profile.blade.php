                ...
                <div class="col-md-12">
                    ...
                    <form action="{{ route('tgg-fct.admin.users.profile.update', $user->id) }}" method="POST">
                        ...
                        <div class="page-text">
                            ...
                            <input type="text" name="rhm_number" class="form-control"
                                value="{{ old('rhm_number', $user->rhm_number) }}">
                        </div>



                        <div class="d-flex">
                            <div class="page-text form-check me-2">
                                <input type="checkbox" name="research_assistance" class="form-check-input"
                                    id="research_assistance" value="1"
                                    {{ $user->research_assistance ? 'checked' : '' }}>
                                <label class="form-check-label" for="research_assistance">Research Assistance</label>
                            </div>
                            <div class="me-2 page-text form-check">
                    ...
                    <hr>
                    <form method="POST" action="{{ route('tgg-fct.admin.users.update.project', $user->id) }}"
                        class="my-2">
                        @csrf
