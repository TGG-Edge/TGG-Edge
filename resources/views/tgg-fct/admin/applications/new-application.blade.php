...
@section('title', 'NEW APPLICATIONS | Tgg Edge | Tgg Fct')
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('tgg-fct.admin.users.update.approval', [$app->id,'action' => 'accepted']) }}" class="text-success">Accept</a> /
                                <a href="{{ route('tgg-fct.admin.users.update.approval', [$app->id,'action' => 'rejected']) }}" class="text-danger">Reject</a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
