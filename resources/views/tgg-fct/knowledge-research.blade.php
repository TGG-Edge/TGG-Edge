...
<div class="container">
    ...
    <div class="input-group search-container">
        <form id="search_form" method="POST" class="col-12 col-md-10 p-0">
            @csrf
            <input type="text" id="searchData" class="form-control col-12 col-md-11 knowledge-innertext mb-2 mb-md-0" style="padding: 1%;font-size: 13px;" placeholder="Example: Rural Development and Sustainable Living..." name="searchData">
            <button type="submit" class="btn btn-outline-secondary knowledge-search" id="searchAI"><i class="fa fa-search"></i></button>
        </form>
    </div>
    <button class="btn btn-primary mt-2 mt-md-3" type="button" id="loaderIcon" style="display:none" disabled>
