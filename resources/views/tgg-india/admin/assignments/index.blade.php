    ...
    <div class="d-flex flex-column flex-lg-row justify-content-between align-items-start align-items-lg-center mb-3">
        ...
        <div class="d-flex align-items-center justify-content-end gap-2 w-100 w-lg-auto mt-2 mt-lg-0">
            @if(request()->has('parent_id'))
                <a href="{{ route('tgg-india.admin.assignments.create', ['parent_id' => request()->parent_id]) }}"
                   class="btn btn-primary assignment-button">
                    <i class="bi bi-plus-lg"></i> New Assignment
                </a>
            @else
                <a href="{{ route('tgg-india.admin.assignments.create') }}" 
                   class="btn btn-primary assignment-button">
                    <i class="bi bi-plus-lg"></i> New Assignment
                </a>
            @endif
        ...
        <table class="table table-striped table-bordered align-middle">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ $assignment->project->business->title ?? 'N/A' }}</td>
                    ...
                    <td>
                        <a href="{{ route('tgg-india.admin.assignments.index', ['parent_id' => $assignment->id]) }}">
                    ...
                    <td class="text-center">
                        <div class="d-flex justify-content-center align-items-center gap-2 flex-wrap">
                            ...
                            <!-- Edit button -->
                            <a href="{{ route('tgg-india.admin.assignments.edit', $assignment->id) }}"
                            ...
                            <!-- Delete button -->
                            <form action="{{ route('tgg-india.admin.assignments.destroy', $assignment->id) }}"
