...
<div class="admin-container">
    ...
    <div class="card p-3">
        ...
        <div class="mt-4 text-end">
            <a href="{{ route('tgg-india.admin.invoices.index') }}" class="btn btn-secondary">Back</a>
            <a href="{{ route('tgg-india.admin.invoices.edit', $invoice->id) }}" class="btn btn-primary">Edit</a>
        </div>
    </div>
</div>
@endsection
