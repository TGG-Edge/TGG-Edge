    ...
    @endphp
    <a href="{{ route('tgg-india.spouse.dashboard') }}"
        class="{{ request()->is('tgg-india/dashboard') ? 'active' : '' }}">
        <i class="fas fa-tachometer-alt"></i> Dashboard
    </a>

    <a href="{{ route('tgg-india.spouse.profile.index') }}" class="{{ request()->is('user/profile') ? 'active' : '' }}"><i
    ...
    @if ($assignments->count() > 0)
        <a href="{{ route('tgg-india.spouse.assignments.index') }}"
    ...
    <div class="dropdown">
        ...
        {{ request()->is('tgg-meta/tgg-india/spouse/incentives*') || request()->is('tgg-meta/tgg-india/spouse/rewards*') || request()->is('tgg-meta/tgg-india/spouse/invoices*') || request()->is('tgg-meta/tgg-india/spouse/receipts*') ? 'active' : '' }}"
            data-bs-toggle="collapse" data-bs-target="#advancementDropdown"
            aria-expanded="{{ request()->is('tgg-meta/tgg-india/spouse/incentives*') || request()->is('tgg-meta/tgg-india/spouse/rewards*') || request()->is('tgg-meta/tgg-india/spouse/invoices*') || request()->is('tgg-meta/tgg-india/spouse/receipts*') ? 'true' : 'false' }}">
            <span><i class="fas fa-arrow-up me-2"></i> Advancement</span>
            <i class="fas fa-caret-down"></i>
        </a>
        <div class="collapse ps-3 {{ request()->is('tgg-meta/tgg-india/spouse/incentives*') || request()->is('tgg-meta/tgg-india/spouse/rewards*') || request()->is('tgg-meta/tgg-india/spouse/invoices*') || request()->is('tgg-meta/tgg-india/spouse/receipts*') ? 'show' : '' }}"
            id="advancementDropdown">
            <a href="{{ route('tgg-india.spouse.incentives.index') }}" class="d-block py-1">
    ...
    <div class="dropdown">
        <a href="#referrallink"
            class="dropdown-toggle d-flex justify-content-between align-items-center {{ request()->is('tgg-meta/tgg-india/spouse/referral/program*') || request()->is('tgg-india/admin/referral/tracking*') ? 'active' : '' }}"
            data-bs-toggle="collapse" role="button"
            aria-expanded="{{ request()->is('tgg-meta/tgg-india/spouse/referral/program*') || request()->is('tgg-india/admin/referral/tracking*') ? 'true' : 'false' }}"
        ...
        <div id="referrallink"
            class="collapse ps-3 {{ request()->is('tgg-meta/tgg-india/spouse/referral/program*') || request()->is('tgg-india/admin/referral/tracking*') ? 'show' : '' }}">
            <a href="{{ route('tgg-india.spouse.referral.program') }}"
                class="d-block py-1 {{ request()->is('tgg-meta/tgg-india/spouse/referral/program*') ? 'active' : '' }}">
                <i class="fas fa-project-diagram me-2"></i>Referral Program
            </a>

            <a href="{{ route('tgg-india.spouse.referral.tracking') }}"
    ...
    @if (url()->current() === url('tgg-meta/tgg-india/spouse/dashboard'))
