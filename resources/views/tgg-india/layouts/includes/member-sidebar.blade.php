    @php
        ...
        ->get();
    @endphp
    <a href="{{ route('tgg-india.member.dashboard') }}" class="{{ request()->is('tgg-india/dashboard') ? 'active' : '' }}">
    ...
    <a href="{{ route('tgg-india.member.assignments.index') }}" class="{{ request()->is('tgg-edge/tgg-fct/assignee/assignments') ? 'active' : '' }}">
