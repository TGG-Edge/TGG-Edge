    ...
    <a href="{{ route('tgg-india.freelancer.profile.index') }}" class="{{ request()->is('user/profile') ? 'active' : '' }}"><i
    ...
    <div class="dropdown">
        ...
        {{ request()->is('tgg-meta/tgg-india/freelancer/incentives*') || request()->is('tgg-meta/tgg-india/freelancer/rewards*') || request()->is('tgg-meta/tgg-india/freelancer/invoices*') || request()->is('tgg-meta/tgg-india/freelancer/receipts*') ? 'active' : '' }}"
            data-bs-toggle="collapse" data-bs-target="#advancementDropdown"
            aria-expanded="{{ request()->is('tgg-meta/tgg-india/freelancer/incentives*') || request()->is('tgg-meta/tgg-india/freelancer/rewards*') || request()->is('tgg-meta/tgg-india/freelancer/invoices*') || request()->is('tgg-meta/tgg-india/freelancer/receipts*') ? 'true' : 'false' }}">
            <span><i class="fas fa-arrow-up me-2"></i> Advancement</span>
            <i class="fas fa-caret-down"></i>
        </a>
        <div class="collapse ps-3 {{ request()->is('tgg-meta/tgg-india/freelancer/incentives*') || request()->is('tgg-meta/tgg-india/freelancer/rewards*') || request()->is('tgg-meta/tgg-india/freelancer/invoices*') || request()->is('tgg-meta/tgg-india/freelancer/receipts*') ? 'show' : '' }}"
            id="advancementDropdown">
            <a href="{{ route('tgg-india.freelancer.invoices.index') }}" class="d-block py-1">
                <i class="fas fa-file-invoice me-2"></i> Invoice
            </a>
            <a href="{{ route('tgg-india.freelancer.receipts.index') }}" class="d-block py-1">
    ...
    <div class="dropdown">
        <a href="#referrallink"
            class="dropdown-toggle d-flex justify-content-between align-items-center {{ request()->is('tgg-meta/tgg-india/freelancer/referral/program*') || request()->is('tgg-india/admin/referral/tracking*') ? 'active' : '' }}"
            data-bs-toggle="collapse" role="button"
            aria-expanded="{{ request()->is('tgg-meta/tgg-india/freelancer/referral/program*') || request()->is('tgg-india/admin/referral/tracking*') ? 'true' : 'false' }}"
        ...
        <div id="referrallink"
            class="collapse ps-3 {{ request()->is('tgg-meta/tgg-india/freelancer/referral/program*') || request()->is('tgg-india/admin/referral/tracking*') ? 'show' : '' }}">
            <a href="{{ route('tgg-india.freelancer.referral.program') }}"
                class="d-block py-1 {{ request()->is('tgg-meta/tgg-india/freelancer/referral/program*') ? 'active' : '' }}">
                <i class="fas fa-project-diagram me-2"></i>Lead Referral Link
        </a>

            <a href="{{ route('tgg-india.freelancer.enquiry.referral.tracking') }}"
                class="d-block py-1 {{ request()->is('tgg-india/freelancer/enquiry.referral/tracking*') ? 'active' : '' }}">
