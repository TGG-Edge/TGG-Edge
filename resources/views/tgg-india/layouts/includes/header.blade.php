    ...
    <div class="container d-flex align-items-center justify-content-between flex-wrap header-container-ipad">
        ...
        <div class="menu-container">    
            <ul class="nav justify-content-center">
                ...
                <li class="nav-item"><a class="nav-link fw-bold text-dark {{ request()->routeIs('tgg-india.show') ? 'active' : '' }}" href="https://thegoldengreens.com/tgg-meta/tgg-india/login/XCJBDSNJK43RWEFSKDJCXNFL34KRN3DKL3MREFWLMNKL32M">Login</a></li>
        ...
        <div class="col-md-3 d-flex justify-content-between align-items-center gap-5 cartnew">
            ...
            <!-- Social Icons -->
            <div class="d-flex gap-1 align-items-center ms-2" style="margin-left: 10rem !important;">
