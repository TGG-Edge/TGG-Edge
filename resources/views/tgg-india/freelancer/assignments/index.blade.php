...
@section('title', 'Assignments freelancer | TGG Meta | TGG India')
...
<div class="admin-container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex align-items-center gap-2">
            ...
            <a href="{{ route('tgg-india.freelancer.assignments.create',[ 'parent_id' => request()->parent_id]) }}" class="btn btn-primary assignment-button"><i class="bi bi-plus-lg"></i>New Assignment</a>
            @endif
        </div>
    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    @endphp
                    @if($grandParent == null)
                        <a href="{{ route('tgg-india.freelancer.assignments.index', ['parent_id' => $assignment->id]) }}">
                    ...
                    @endif
                    {{-- <a href="{{ route('tgg-india.freelancer.assignments.index', [ 'parent_id' => $assignment->id])  }}">{{ $assignment->children ? $assignment->children->count() : 0 }}</a> --}}
                </td>
                <td>
                    <div class="d-flex align-items-center justify-content-center">
                    <a href="{{ route('tgg-india.freelancer.assignments.edit', $assignment) }}" class="btn btn-primary btn-sm d-flex align-items-center justify-content-center p-0 me-2" 
                    ...
                    <a href="{{ $invoiceExists ? '#' : route('tgg-india.freelancer.invoices.global-store', [
