...
<div class="admin-container">
    ...
    <div class="card p-3 mb-4">
        <form action="{{ route('tgg-india.spouse.assignments.update', $assignment->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <a href="{{ route('tgg-india.spouse.assignments.index') }}" class="btn btn-secondary">Cancel</a>
        </form>
    </div>
</div>
@endsection
