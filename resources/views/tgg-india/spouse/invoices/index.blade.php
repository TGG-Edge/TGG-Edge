...
<div class="admin-container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex align-items-center justify-content-end gap-2">
            <a href="{{ route('tgg-india.spouse.invoices.create') }}" class="btn btn-primary assignment-button">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="{{ route('tgg-india.spouse.invoices.show', $invoice->id) }}" class="btn btn-info btn-sm me-2 d-flex align-items-center justify-content-center p-0" style="width:28px;height:28px;">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('tgg-india.spouse.invoices.edit', $invoice->id) }}" class="btn btn-primary btn-sm me-2 d-flex align-items-center justify-content-center p-0" style="width:28px;height:28px;">
                                <i class="fas fa-edit"></i>
                            </a>

                            {{-- Download PDF --}}
                            <a href="{{ route('tgg-india.spouse.invoices.download', $invoice->id) }}" 
                            ...
                            <form action="{{ route('tgg-india.spouse.invoices.destroy', $invoice->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
