...
<div class="admin-container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex align-items-center justify-content-end gap-2">
            <a href="{{ route('tgg-india.advisor.receipts.create') }}" class="btn btn-primary assignment-button">
                ...
                <tr>
                    ...
                    <td>
                        <div class="d-flex align-items-center justify-content-center">
                            <a href="{{ route('tgg-india.advisor.receipts.show', $receipt->id) }}" class="btn btn-info btn-sm me-2 d-flex align-items-center justify-content-center p-0" style="width:28px;height:28px;">
                                <i class="fas fa-eye"></i>
                            </a>
                            <a href="{{ route('tgg-india.advisor.receipts.edit', $receipt->id) }}" class="btn btn-primary btn-sm me-2 d-flex align-items-center justify-content-center p-0" style="width:28px;height:28px;">
                            ...
                            <form action="{{ route('tgg-india.advisor.receipts.destroy', $receipt->id) }}" method="POST" style="display:inline;">
                                @csrf
                                @method('DELETE')
