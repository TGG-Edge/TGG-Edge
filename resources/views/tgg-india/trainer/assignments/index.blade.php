...
@section('title', 'Assignments trainer | TGG Meta | TGG India')
...
<div class="admin-container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <div class="d-flex align-items-center gap-2">
            {{-- <a href="{{ route('tgg-india.trainer.assignments.create') }}" class="btn btn-primary assignment-button"><i class="bi bi-plus-lg"></i>New Assignment</a> --}}
        </div>
    </div>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    ...
                    <a href="{{ route('tgg-india.trainer.assignments.edit', $assignment) }}" class="btn btn-primary btn-sm d-flex align-items-center justify-content-center p-0 me-2" 
                    ...
                    <a href="{{ $invoiceExists ? '#' : route('tgg-india.trainer.invoices.global-store', [
