...
<div class="admin-container container-fluid py-3">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
        <h4 class="mb-3 trainer-heading text-center text-md-start w-100 w-md-auto">Sections</h4>
        <div class="d-flex flex-wrap align-items-center gap-2 justify-content-center justify-content-md-end w-100 w-md-auto">
            ...
            <tbody>
                @forelse ($sections as $index => $section)
                    <tr>
                        ...
                        <td>{{ $section->title }}</td>
                        <td>
                            <a href="{{ route('tgg-india.trainer.chapters.index',['section_id' => $section->id]) }}">
                                {{ $section->chapters ? $section->chapters->count() : 0 }}
                            </a>
                        </td>
