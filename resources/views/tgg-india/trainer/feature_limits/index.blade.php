        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <form action="{{ route('tgg-india.trainer.feature-limits.setPrice') }}" method="POST"
                    ...
                    @csrf
                    <input type="number" title="This is the price members will need to pay once they exceed their free limit." name="price" class="form-control" placeholder="Set Price" style="width: 120px;"
                    ...
                    <button type="submit" title="This is the price members will need to pay once they exceed their free limit." class="btn btn-primary create-button" @if (!$featureLimits[0] || $featureLimits[0]->created_by !== Auth('web2')->id()) disabled @endif>
                        Save
                    </button>
                </form>
               

                <a href="{{ route('tgg-india.trainer.feature-limits.create') }}"
                    class="btn btn-primary create-button">Create New</a>
            </div>
        </div>
