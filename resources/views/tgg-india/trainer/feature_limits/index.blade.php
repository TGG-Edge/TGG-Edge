    ...
    <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3 gap-2">
        ...
        <div class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-2 w-100 w-md-auto">
            ...
            <form action="{{ route('tgg-india.trainer.feature-limits.setPrice') }}" method="POST"
                class="d-flex flex-column flex-md-row align-items-start align-items-md-center gap-2 w-100 w-md-auto">
                @csrf
                <input type="number" 
                       title="This is the price members will need to pay once they exceed their free limit." 
                       name="price" 
                       class="form-control" 
                       placeholder="Set Price" 
                       style="width: 120px;"
                       @if (!$featureLimits[0] || $featureLimits[0]->created_by !== Auth('web2')->id()) disabled @endif 
                       value="{{ $featureLimits[0]->price ?? '' }}">
