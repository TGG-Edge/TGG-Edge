...
<div class="admin-container">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h4 class="mb-3 trainer-heading">Feature Limits</h4>
            ...
            <a href="{{ route('tgg-india.trainer.feature-limits.create') }}" class="btn btn-primary create-button">Create New</a>
            </div>
    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex align-items-center justify-content-center">
                                ...
                                <form action="{{ route('tgg-india.trainer.feature-limits.destroy', $feature->id) }}" method="POST" 
