...
<div class="container referral-page">
    <div class="card shadow-lg p-4">
        ...
        <p class="text-center" style="font-size:14px; max-width: 700px; margin: auto;">
            You are a proud member of <strong>TGG India</strong>. Invite your friends to join our program.  
        ...
        <p>
            The TGG India Referral Program allows members to earn rewards by inviting others to join.  
