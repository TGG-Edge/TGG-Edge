...
class ApplicationController extends Controller
{
    ...
    {
        $newApplications = User::whereIn('user_role', [2,3,4,5,6])->where('approval','pending')->latest()->paginate(10);
        return view('tgg-fct.admin.applications.new-application', compact('newApplications'));
    }

    public function processedApplication()
    {
       $processedApplications = User::whereIn('user_role', [2,3,4,5,6])->where('approval','!=','pending')->latest()->paginate(10);
        return view('tgg-fct.admin.applications.processed-application', compact('processedApplications'));
    }
