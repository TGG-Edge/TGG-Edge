...
namespace App\Http\Controllers\TggFct\Volunteer;
...
class ProjectController extends Controller
{
    ...
    public function researcherProject()
    {
        ...
        return view('tgg-fct.volunteer.projects.researcher-project',compact('researchProjects'));
    }

    public function volunteerProject()
    {
        $volunteerProjects = ProjectCollaboration::where('document_url','!=',null)->latest()->paginate(10);
        return view('tgg-fct.volunteer.projects.volunteer-project' , compact('volunteerProjects'));
    }
