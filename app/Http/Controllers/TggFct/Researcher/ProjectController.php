...
class ProjectController extends Controller
{
    ...
    public function researcherProject()
    {
        ...
        return view('tgg-fct.researcher.projects.researcher-project',compact('researchProjects'));
    }

    public function volunteerProject()
    {
        $volunteerProjects = ProjectCollaboration::where('document_url','!=',null)->latest()->paginate(10);
        return view('tgg-fct.researcher.projects.volunteer-project' , compact('volunteerProjects'));
    }
