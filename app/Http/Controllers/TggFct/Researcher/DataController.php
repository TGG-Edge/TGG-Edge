...
class DataController extends Controller
{
    ...
    {
        return view('tgg-fct.researcher.ai-tools-research.visualization-analytics.upload');
    }
    ...
    public function upload(Request $request)
    {
        ...
        return view('tgg-fct.researcher.ai-tools-research.visualization-analytics.visualize', [
            'headers' => $headers,
            'columns' => $columns,
