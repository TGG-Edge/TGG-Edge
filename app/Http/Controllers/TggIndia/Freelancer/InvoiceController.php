...
class InvoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tgg-india.freelancer.invoices.index', compact('invoices'));
    ...
    public function create()
    {
        ...
        return view('tgg-india.freelancer.invoices.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $invoice->items = $items;
        $invoice->save();
        return redirect()->route('tgg-india.freelancer.invoices.index')->with('success', 'Invoice created successfully.');
    ...
    public function show(Invoice $invoice,$id)
    {
        ...
        return view('tgg-india.freelancer.invoices.show', compact('invoice'));
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('tgg-india.freelancer.invoices.edit', compact('invoice', 'users'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('tgg-india.freelancer.invoices.index')->with('success', 'Invoice updated successfully.');
    }
    ...
    public function download(Invoice $invoice, $id)
    {
        ...
        $pdf = Pdf::loadView('tgg-india.freelancer.invoices.pdf', compact('invoice'))
            ->setPaper('A4');
