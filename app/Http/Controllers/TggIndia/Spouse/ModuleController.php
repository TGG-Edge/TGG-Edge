...
class ModuleController extends Controller
{
    ...
    public function chapters(Chapter $chapter,$id)
    {
        ...
        return view('tgg-india.spouse.modules.investments.chapters', compact('chapter'));
    }
    ...
    public function links(Request $request)
    {
        ...
        return view('tgg-india.spouse.modules.investments.links', compact('links'));
    }
    ...
    public function videos(Request $request)
    {
        ...
        return view('tgg-india.spouse.modules.investments.videos', compact('videos'));
    }
}
