...
class ModuleController extends Controller
{
    ...
    public function chapters(Chapter $chapter,$id)
    {
        ...
        return view('tgg-india.facilitator.modules.investments.chapters', compact('chapter'));
    }
    ...
    public function links(Request $request)
    {
        ...
        return view('tgg-india.facilitator.modules.investments.links', compact('links'));
    }
    ...
    public function videos(Request $request)
    {
        ...
        return view('tgg-india.facilitator.modules.investments.videos', compact('videos'));
    }
}
