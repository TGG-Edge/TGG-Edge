...
class AssignmentController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('tgg-india.facilitator.assignments.index', compact('assignments'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->filled('parent_id')) {
            return redirect()
                ->route('tgg-india.facilitator.assignments.index', ['parent_id' => $request->parent_id])
                ->with('success', 'Sub-assignment created successfully.');
        }

        return redirect()->route('tgg-india.facilitator.assignments.index')->with('success', 'Assignment created successfully.');
    }
    ...
    public function update(Request $request, AssignmentSecondary $assignment)
    {
        ...
        if ( $assignment->parent_id != null)  {
            return redirect()
                ->route('tgg-india.facilitator.assignments.index', ['parent_id' => $assignment->parent_id])
                ->with('success', 'Sub-assignment updated successfully.');
        }

        return redirect()->route('tgg-india.facilitator.assignments.index')->with('success', 'Assignment updated successfully.');
    }
