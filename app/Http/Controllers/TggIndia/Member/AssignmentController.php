...
class AssignmentController extends Controller
{
    public function index()
    {
        ...
        return view('tgg-india.member.assignments.index', compact('assignments'));
    }

    public function create()
    {
        return view('tgg-india.member.assignments.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('tgg-india.member.assignments.index')->with('success', 'Assignment created successfully.');
    }
    ...
    public function edit(AssignmentSecondary $assignment)
    {
        ...
        return view('tgg-india.member.assignments.edit', compact('assignment'));
    }
    ...
    public function update(Request $request, AssignmentSecondary $assignment)
    {
        ...
        return redirect()->route('tgg-india.member.assignments.index')->with('success', 'Assignment updated successfully.');
    }
