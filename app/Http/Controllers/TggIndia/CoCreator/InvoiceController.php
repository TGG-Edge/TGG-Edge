...
class InvoiceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('tgg-india.co-creator.invoices.index', compact('invoices'));
    ...
    public function create()
    {
        ...
        return view('tgg-india.co-creator.invoices.create', compact('users'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $invoice->items = $items;
        $invoice->save();
        return redirect()->route('tgg-india.co-creator.invoices.index')->with('success', 'Invoice created successfully.');
    ...
    public function show(Invoice $invoice,$id)
    {
        ...
        return view('tgg-india.co-creator.invoices.show', compact('invoice'));
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('tgg-india.co-creator.invoices.index')->with('success', 'Invoice updated successfully.');
    }
    ...
    public function download(Invoice $invoice, $id)
    {
        ...
        $pdf = Pdf::loadView('tgg-india.co-creator.invoices.pdf', compact('invoice'))
            ->setPaper('A4');
